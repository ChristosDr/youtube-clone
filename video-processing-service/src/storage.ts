...
const rawVideoBucketName = "chris-yt-videos";//People are going to upload theur videos here
const processedVideoBucketName= "chris-processed-yt-videos";//Upload the processed videos here
